...
class SynchronousSocketServer
{
    ...
    private static string GoToRoot;
    ...
    private static Dictionary <int, string> ErrCodes = new Dictionary<int, string>(3)
    {
    ...
    public SynchronousSocketServer(int port)
    { 
      Port = port;
      ServerAddress = Host+":"+Port;
      GoToRoot = "<h4><a href='http://" + ServerAddress + "?adress=" + DefaultDir + "'>Go to Root</a></h4>"; // for "go to root" button - will use several times
    } 
    ...
    private static void SendWarnAnswer(Socket handler, int ErrorCode, string BackButton)
    {  
    ...
    private static string GetBackButton(string address)
    {  
        BackButton = "";
    ...
    private static (FileInfo[], DirectoryInfo[]) GetFilesAndDirs(string address)
    {  
